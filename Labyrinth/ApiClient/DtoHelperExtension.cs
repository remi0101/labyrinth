...
namespace Labyrinth.ApiClient
{
    public static class DtoHelperExtension
    {
        ...
        public static async Task<Dto.InventoryItem[]> GetApiInventoryItems(this Inventory content)
        {
            var itemTypes = await content.ItemTypes;
            return [.. itemTypes.Select(type => new Dto.InventoryItem
            {
